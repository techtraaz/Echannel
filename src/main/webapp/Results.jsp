...
<h2 id="sh2">Available Sessions</h2>
...
<table>
    ...
    <tbody>
        <c:forEach var="session" items="${sessiondetails}">
            <tr>
                ...
                <td>
                    <!-- Redirect to Booking.jsp with session ID as query parameter -->
                    <form action="Booking.jsp" method="get">
                        <!-- Assuming 'session_id' is available in the session object -->
...
<!-- Handle the case where no session details are available -->
<c:if test="${empty sessiondetails}">
